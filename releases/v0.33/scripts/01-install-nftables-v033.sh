...
# Nftables Fail2Ban Configuration v0.33
...
# Version: 3.3 (final v0.33 structure, based on v0.31)
# Date: 2026-01-01
# Changelog:
...
################################################################################
# KROK 4: VYTVOR VŠETKY SETY (12 x IPv4 + IPv6) - RECIDIVE 30d!
################################################################################
...
log_info "INPUT reťazec (24 pravidiel: 12 IPv4 + 12 IPv6)..."
...
echo "  4. Vytvorenie všetkých 12 setov (IPv4 + IPv6)"
echo "     ✓ f2b-recidive: 30 days timeout (2592000s)"
echo "     ✓ ostatné: 7 days timeout (604800s)"
echo "  5. Pridanie DROP pravidiel (24 INPUT + 8 FORWARD)"
