#!/bin/bash
################################################################################
# Pre-Installation Cleanup for Fail2Ban + nftables v0.21
...
echo ""
echo "╔═══════════════════════════════════════════════════════╗"
echo "║   Pre-Installation Cleanup v0.21                     ║"
echo "╚═══════════════════════════════════════════════════════╝"
echo ""
...
echo ""
echo "🚀 Ready for v0.21 installation!"
echo ""
echo "Next steps:"
echo "  1. Review backup if needed: ls -lh $BACKUP_DIR"
echo "  2. Run installer: sudo bash INSTALL-ALL-v021.sh"
echo ""
