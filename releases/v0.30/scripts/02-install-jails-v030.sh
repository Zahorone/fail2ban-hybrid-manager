...
echo "║  11 Jails + 11 Filters + Actions (recidive 30d)            ║"
echo "║                                                            ║"
echo "╚════════════════════════════════════════════════════════════╝"
echo ""
...
################################################################################
# KROK 3: INSTALL FILTERS
################################################################################
log_header "═══ KROK 3: INSTALL FILTERS (11) ═══"
...
if [ -f "$ACTIONS_DIR/nftables.conf.local" ]; then
    ...
    echo "✓ (addr_set=f2b-<name>, table=fail2ban-filter)"
else
...
echo ""
echo "Next steps:"
echo "  1. sudo bash 01-install-nftables-v024.sh"
echo "  2. sudo bash 02-verify-jails-v024.sh"
echo ""
