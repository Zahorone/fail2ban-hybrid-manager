#!/bin/bash
################################################################################
# F2B Wrapper v0.21 Installation Script
...
WRAPPER_SOURCE=""
if [ -f "$SCRIPT_DIR/f2b-wrapper-v021.sh" ]; then
    WRAPPER_SOURCE="$SCRIPT_DIR/f2b-wrapper-v021.sh"
elif [ -f "$SCRIPT_DIR/f2b-wrapper.sh" ]; then
    WRAPPER_SOURCE="$SCRIPT_DIR/f2b-wrapper.sh"
elif [ -f "$HOME/f2b-wrapper-v021.sh" ]; then
    WRAPPER_SOURCE="$HOME/f2b-wrapper-v021.sh"
else
    error "F2B wrapper script not found. Please ensure f2b-wrapper-v021.sh is in: $SCRIPT_DIR"
fi
...
echo "  f2b monitor trends      - Attack trend analysis"
echo "  f2b monitor jail-log    - Show jail logs"
echo "  f2b report json         - Export JSON report"
echo "  f2b report csv          - Export CSV report"
echo ""
echo "Management:"
echo "  f2b manage block-port <port>     - Block Docker port"
echo "  f2b manage manual-ban <ip>       - Ban IP manually"
echo "  f2b find <ip>                    - Find IP in jails"
echo ""
echo "Full Help:"
echo "  f2b help"
echo ""
...
echo ""
echo "4. View attack trends:"
echo "   sudo f2b monitor trends"
echo ""
