...
echo "  f2b-trends          - Attack trends (NEW)"
echo "  f2b-log <jail>      - Jail log (NEW)"
echo ""
echo "Port Management:"
echo "  f2b-block-port <p>  - Block port"
echo "  f2b-unblock-port <p> - Unblock port"
echo "  f2b-list-ports      - List blocked"
echo "  f2b-docker          - Docker-block info"
echo ""
echo "IP Management:"
echo "  f2b-ban <ip> [time] - Ban IP"
echo "  f2b-unban <ip>      - Unban IP"
echo ""
echo "System:"
